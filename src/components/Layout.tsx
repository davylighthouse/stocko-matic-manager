...
import { BarChart2, Package, Upload, LogOut, ClipboardList, Database, Settings, PoundSterling } from "lucide-react";
...
const navigation = [
  ...
  { name: "Profitability", path: "/profitability", icon: PoundSterling },
